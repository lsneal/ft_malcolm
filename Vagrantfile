...
Vagrant.configure("2") do |config|
	...
	config.vm.define "blackhat" do |c|
		...
		c.vm.network "private_network", ip: "192.168.42.2", name: "vboxnet1"
	...
	config.vm.define "target1" do |c|
		...
		c.vm.network "private_network", ip: "192.168.42.3", name: "vboxnet1"
	...
	config.vm.define "target2" do |c|
		...
		c.vm.network "private_network", ip: "192.168.42.4", name: "vboxnet1"
